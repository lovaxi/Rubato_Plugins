...
// in the clientId (Codex-RUBATO-<mac6> for this Codex plugin).
...
export async function publishRecord(config, record) {
  // clientId goes to the broker exactly as derived (Codex-RUBATO-<mac6>) —
  // precise use, no random suffix (spec §2.2).
